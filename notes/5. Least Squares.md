...
![3D Points Approximated by a Plane](/assets/images/image5.png)

But how do we find the best possible plane? Well, to do that, we need to minimize the distance of the points from the plane.

![Minimizing the Distance from the Plane](/assets/images/image6.png)
...
![Points Lying Close to a Plane](/assets/images/image2.png)
...
![Perpendicular Drop from Point A to the Line](/assets/images/image3.png)
...
![Projection of Point A on the Line](/assets/images/image4.png)
